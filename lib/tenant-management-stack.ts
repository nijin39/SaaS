...
export class TenantManagementStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // DynamoDB 테이블 생성
    const table = new dynamodb.Table(this, "TenantManagementTable", {
      partitionKey: { name: "id", type: dynamodb.AttributeType.STRING },
      tableName: "TenantManagement",
      removalPolicy: cdk.RemovalPolicy.DESTROY, // 배포 시 테이블 삭제 설정
    });

    const myLambda = new lambda.Function(this, "TenantManagementFunction", {
      runtime: lambda.Runtime.NODEJS_14_X,
      handler: "tenant-management.handler",
    ...
    const api = new apigateway.RestApi(this, "TenantManagementAPI", {
      restApiName: "TenantManagement",
    });
