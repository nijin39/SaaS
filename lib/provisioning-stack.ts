...
export class ProvisioningStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // DynamoDB 테이블 생성
    const table = new dynamodb.Table(this, "ProvisioningTable", {
      partitionKey: { name: "id", type: dynamodb.AttributeType.STRING },
      tableName: "Provisioning",
      removalPolicy: cdk.RemovalPolicy.DESTROY, // 배포 시 테이블 삭제 설정
    });

    const myLambda = new lambda.Function(this, "ProvisioningFunction", {
    ...
    const api = new apigateway.RestApi(this, "ProvisioningAPI", {
      restApiName: "Provisioning",
    });
